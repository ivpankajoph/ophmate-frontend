    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex justify-end mb-6">
          <button className="text-white px-6 py-3 rounded-full font-semibold transition-colors template-accent-bg template-accent-bg-hover">
            View cart
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {quantity > 0 && (
                <div className="grid grid-cols-12 gap-4 p-4 items-center border-b">
                  ...
                  <div className="col-span-5 flex items-center gap-4">
                    ...
                    />
                    <a href="#" className="font-medium template-accent">
                      Golden Glow
                    </a>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <button className="w-full text-white py-4 rounded-full font-semibold transition-colors text-lg template-accent-bg template-accent-bg-hover">
                Proceed to checkout
              </button>
            </div>
          </div>
